...
\textbf{\huge{}RISC-V Betaflight Autopilot}\textbf{\\[0.4cm] % Title of your document
 \HRule\\[1.5cm]}
...
\subsubsection{Betaflight}
Betaflight is an open-source flight control software for drones and fixed-wing aircraft. Written in the C language, Betaflight currently supports over 100 flight control board models. Users compile and build model-specific versions of Betaflight through a Google App or using a command line interface. Betaflight currently only supports flight control boards with STM32 RISC microcontrollers.
...
\begin{itemize}
    ...
    \item Github merge request (to incorporate the RISC-V port into Betaflight’s mainstream repository)
...
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=130mm,scale=1]{Block diagram V2.jpg}
\end{figure}

\subsubsection{Betaflight’s Makefile}
...
\begin{enumerate}
    \item Start with the Betaflight makefile.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Flash Betaflight to stock board
...
We plan to incorporate three phases of testing throughout the project: One phase of unit-testing for the receiver module, another for the accelerometer and ESC modules, and a third phase for final integration testing. As part of the integration testing, we will swap the kit’s stock flight control board (SPRacingF3) with the HiFive1 Rev. B running the ported Betaflight firmware.
